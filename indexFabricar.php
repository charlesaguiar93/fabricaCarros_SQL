...
<body>
    ...
    <div class="container mb-4  border-info"><br><br>
         <div class="card card-custom border-info bg-light">
             <div class="card-body">
    <h2 class="display-4">🏭 Fabricar carros <i class="bi bi-car-front-fill"></i></h2>
 ...
 <div class="input-group mb-3">
  ...
  <div class="input-group-append">
    <span class="input-group-text" id="basic-addon2">Cor</span>
  </div>
</div>
